...
_BOXPLOT: x is categorical, and y is continuous; and boxplot is to show the range of a data, usually don't need to summarize before plotting_
...
How could we represent this as a plot? _no need to summarize because boxplot will do it for you_
```{r}
homerange %>% 
