...
_long structure_
_there are 95.7% of missing data on wild life cases, and they were represented as "NA"_
```{r}
sharks
```
...
_San Diego has the highest total number of injuries among all the counties_
