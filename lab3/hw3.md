...
##  NA's   :502
```
preymass, log10.preymass, and PPMR has 502 NA.
...
N and alternative.mass.reference shouldn't be in class character because some data recorded numerical numbers and they should be take into account.
...
## #   PPMR <dbl>, prey.size.reference <chr>
```
reindeer has the largest mean.hra.m2, which is the largest home range area, because they are the largest and most numerous herbivores in circumpolar areas.
